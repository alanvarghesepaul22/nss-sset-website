...
if (isset($_GET['view_id'])) {
    ...
    $select_donor_query = "Select * from donor_details where donor_id='$id'";
    $result_donor = mysqli_query($con, $select_donor_query);
    $donor_rows_count = mysqli_num_rows($result_donor);
    $fetchData = mysqli_fetch_assoc($result_donor);

    $dona_email = $fetchData['donor_email']; // to select users with same donor email and donation email 

    $select_donation_query = "Select * from donation_details where dona_email='$dona_email'";
    $result_donation = mysqli_query($con, $select_donation_query);
    $donation_rows_count = mysqli_num_rows($result_donation);
    $fetchDonaData = mysqli_fetch_assoc($result_donation);

    $conf_email = $fetchData['donor_email'];
    ...
    if (isset($_POST['donated_update'])) {
        ...
        if ($dateOfDonation > $today) {
            ...
            header('location:view_donor_details.php?view_id=' . $id);
            exit(0);
        } else {
...
<body>
    ...
    <div class="container-redir">
        <div class="card-redir">
            <div class="content-don-rel">
                <h4 class="sect-title">Donor Details</h4>
                ...
                <div class="h3-body-redir">
                    <div class="h3-body1-redir">
                        <h3 class="h3-redir">
                            ...
                            <p class="p-details">
                                <?php
                                echo  ucwords($fetchData['donor_name']);
                                ?>
                            </p>
    ...
    <div class="container-don-rel">
        <div class="card-don-rel">
            <div class="content-don-rel">
                <h4 class="sect-title">Update Your Latest Donation Details</h4>
    ...
    <div class="container-don-rel">
        <div class="card-don-rel">
            ...
            <div class="content-don-rel">
                <h4 class="sect-title">Donation History</h4>
                <div class="h3-body-don-rel">
                    <?php
                    ...
                    <?php
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                while ($fetchDona = mysqli_fetch_assoc($result_donation)) : ?>

                                    <tr>
                                        <td><?php echo $fetchDona['dona_date']; ?></td>
                                        <td> <?php echo $fetchDona['dona_hospName']; ?></td>
                                        <td><a href='../user_area/common_user_func/certif_show.php?certif=<?php echo $fetchDona['dona_id']; ?>' target="_blank" class='butn-a-don-rel'> <button class='butn-don-rel1 fullscreen_toggle' name='view_certif'><i class='bi bi-arrows-fullscreen'></i> View Certificate</button></a></td>
                                        <td>
                                            <a href='admin_edit_donat_details.php?edit=<?php echo $fetchDona['dona_id']; ?>' class='butn-a-don-rel'><button class='butn-don-rel1 edit_toggle' name='donated_edit'><i class='bi bi-pencil-square'></i></button></a>
                                            <a href='admin_delete_donat_details.php?delete=<?php echo $fetchDona['dona_id']; ?>' class='butn-a-don-rel'><button class='butn-don-rel1 delete_toggle' name='donated_delete'><i class='bi bi-trash3'></i></button></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
