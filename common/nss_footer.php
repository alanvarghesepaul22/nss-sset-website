...
<footer>
    <div class="footer-body">
        ...
        <div class="footer-bottom">
            <span class="footer-copyright">Copyright © 2022 <a href="./index.php">NSS-SSET</a> <br> All rights reserved</span>
            <span class="footer-policy-terms">
                <a href="#">Privacy policy</a> <br>
                <a href="#">Terms & condition</a>
            </span>
            <span><a href="./BloodWay_PHP/admin_area/admin_login.php">Admin Dashboard</a></span>
        </div>
    </div>
</footer>